...
--
-- Host: localhost
-- Generation Time: Dec 18, 2012 at 02:25 AM
...
CREATE TABLE IF NOT EXISTS `entity_types` (
  ...
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=801 ;
...
CREATE TABLE IF NOT EXISTS `revisions` (
  ...
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5366 ;
