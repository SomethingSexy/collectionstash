			...
			<div class="collectible add">
				<?php 
					if (isset($collectible['Upload'])) { ?>
						...
						<div class="links">
							<?php 
								echo $this -> Form -> create('Collectible', array('url' => $this->here, 'type' => 'file', 'id' => 'remove-image-form'));
				...
				<?php } else { ?>
					<?php echo $this -> Form -> create('Collectible', array('url' => $this->here, 'id'=>'add-image-form', 'type' => 'file'));?>
					<fieldset>
					...
					<div class="links no-image">
						<input type="input" id="add-image-button" value="Add Image">
