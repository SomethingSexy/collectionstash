<div class="container2">
  <div class="info">
    ...
    <div>You have submitted the following collectible to be added.  You will receive a confirmation e-mail once the collectible has been approved.  You will then be able to add it to your stash!</div>
  </div>
