...
class UserPointFact extends AppModel
{
    ...
    public function getUserTotalPointsYear($userId, $year) {
        $retVal = 0;
        $points = $this->find('all', array('contain' => array('User' => array('fields' => array('username', 'id'))), 'conditions' => array('UserPointFact.user_id' => $userId, 'UserPointFact.year' => $year)));
    ...
    public function getMonthlyLeaders($month, $year) {
        ...
        $retVal = $this->find('all', array('contain' => array('User' => array('fields' => array('username', 'id'))), 'limit' => 5, 'order' => array('UserPointFact.points' => 'desc'), 'conditions' => array('UserPointFact.month' => $month, 'UserPointFact.year' => $year, 'NOT' => array('UserPointFact.user_id' => array('1')))));
    ...
    public function getLeadersByYear($year) {
        // TODO get to work
        $retVal = $this->find('all', array('contain' => array('User' => array('fields' => array('username', 'id'))), 'group' => 'UserPointFact.user_id', 'conditions' => array('UserPointFact.year' => '2012')));
