...
class UserPointYearFact extends AppModel {
	...
	public function getLeadersByYear($year) {
		...
		$retVal = $this -> find('all', array('limit' => 5, 'order' => array('UserPointYearFact.points' => 'desc'), 'conditions' => array('UserPointYearFact.year' => $year, 'NOT' => array('UserPointYearFact.user_id' => array('1')))));
