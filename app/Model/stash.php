...
class Stash extends AppModel {
    ...
    public $hasMany = array('CollectiblesUser' => array('dependent' => true), 'Comment' => array('conditions' => array('Comment.type' => 'stash'), 'foreignKey' => 'type_id'));
    ...
    var $validate = array('name' => array('validValues' => array('rule' => '/^[\\w\\s-]+$/', 'message' => 'Alphanumeric only'), 'length' => array('rule' => array('maxLength', 50), 'message' => 'Max length of 50.')), 'privacy' => array('rule' => array('inList', array('0', '1')), 'message' => 'That value does not seem right.'));
