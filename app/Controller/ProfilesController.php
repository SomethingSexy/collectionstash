...
class ProfilesController extends AppController {
	...
	public function index() {
		...
		// build model data
		$profile = array('first_name' => $user['User']['first_name'], 'last_name' => $user['User']['last_name'], 'email' => $user['User']['email'], 'email_notification' => $profile['Profile']['email_notification'], 'email_newsletter' => $profile['Profile']['email_newsletter']);
