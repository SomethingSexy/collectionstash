...
class StashSearchComponent extends Component
{
    ...
    public function search($user) {
        ...
        $this->controller->paginate = array('paramType' => 'querystring', 'findType' => 'orderCustom', 'joins' => $joins, 'limit' => 25, 'order' => array('sort_number' => 'desc'), 'conditions' => $conditions, 'contain' => array('Condition', 'Merchant', 'UserUpload', 'Collectible' => array('User' => array('fields' => array('id', 'username')), 'CollectiblePriceFact', 'CollectiblesUpload' => array('Upload'), 'Manufacture', 'Collectibletype', 'ArtistsCollectible' => array('Artist'))));
