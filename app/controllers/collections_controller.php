...
class CollectionsController extends AppController {
	...
	function stash($username=null) {
		...
		$data = $this -> User -> Stash -> CollectiblesStash -> find("all", array('conditions' => array('CollectiblesStash.stash_id' => $id),
		//'limit' => 1,
			'contain' => array('Collectible' => array('Manufacture', 'Collectibletype', 'Upload'))));
