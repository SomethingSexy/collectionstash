...
var PaginatedCollection = Backbone.Paginator.requestPager.extend({
	...
	paginator_core : {
		...
		url : function() {
			var url = '/collectibles/userHistory/' + userId + '/page:' + this.currentPage;
...
$(function() {
	...
	$.when($.get('/templates/user/collectible.dust'), $.get('/templates/user/collectibles.dust'), $.get('/templates/user/edit.dust'), $.get('/templates/user/edits.dust'), $.get('/templates/user/pending.dust'), $.get('/templates/user/pending.collectible.dust'), $.get('/templates/user/new.collectibles.dust'), $.get('/templates/user/new.collectible.dust')).done(function(collectibleTemplate, collectiblesTemplate, editTemplate, editsTemplate, pendingTemplate, pendingCollectibleTemplate, newTemplate, newCollectibleTemplate) {
