...
], function(Backbone, $, AlertView, CollectibleDeleteView, ManufacturerView, CollectibleView, AddPersonView, CollectibleModel, Status, StatusView, PaginatedCollection, PaginatedPart) {
    /**
     * TODO: Known Issues:
