define(['require', 'marionette', 'text!templates/app/user/profile/history.row.mustache', 'mustache', 'marionette.mustache'], function(require, Marionette, template, mustache) {
