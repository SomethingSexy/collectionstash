define(['require', 'marionette', 'text!templates/app/user/profile/submission.mustache', 'mustache', 'marionette.mustache'], function(require, Marionette, template, mustache) {
