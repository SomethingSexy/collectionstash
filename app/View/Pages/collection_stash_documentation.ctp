...
<div class="col-md-3">
	<div class="affix nav-sidebar">
		<ul class="nav nav-list">
			<li>
				<a href="#overview">What is a Collectible? </a>
			</li>
			<li>
				<a href="#stash">Your Stash </a>
				<ul class="nav nav-list">
					<li>
						<a href="#stash-add">Adding Collectibles to your Stash </a>
					</li>
					<li>
						<a href="#stash-photos">Photos</a>
						<ul class="nav nav-list">
							<li>
								<a href="#stash-photos-upload">Uploading</a>
							</li>
							<li>
								<a href="#stash-photos-edit">Editing</a>
							</li>
							<li>
								<a href="#stash-photos-sharing">Editing</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<li>
				<a href="#submit-new">Submitting a New Collectible </a>
				<ul class="nav nav-list">
					<li>
					...
					<li>
						...
						<ul class="nav nav-list">
							<li>
								<a href="#parts-adding-new-parts">Adding New Parts to a Collectible </a>
							</li>
							<li>
								<a href="#parts-add-existing">Adding Existing Parts to a Collectible </a>
							</li>
							<li>
								<a href="#parts-photos">Adding Photos </a>
							</li>
							<li>
								<a href="#parts-duplicate">Removing Duplicate Parts </a>
							</li>
							<li>
								<a href="#parts-when">When should I add a new part vs adding an existing part? </a>
							</li>
							<li>
								<a href="#parts-customs">Adding Parts to Custom Collectibles </a>
							</li>
							<li>
								<a href="#parts-original">Adding Parts to Original Collectibles </a>
							</li>
						</ul>
					</li>
					<li>
						<a href="#submit">Submitting/Activating a Collectible </a>
					</li>
					<li>
						<a href="#delete">Deleting a Collectible </a>
					</li>
				</ul>
			</li>
			<li>
				<a href="#listings">Sale Listings and Transactions</a>
				<ul class="nav nav-list">
					<li>
						<a href="#listings-add">Adding a Listing </a>
					</li>
					<li>
						<a href="#listings-price-guide">Price Guide </a>
					</li>
				</ul>
			</li>
		</ul>
...
<div class="col-md-9">
	...
	<div class="page-header">
		<h1 id="overview">What is a Collectible?</h1>
	</div>
	<p>
	...
	<p>
		There are many places throughout Collection Stash where you can add a collectible to your stash.  The <img src="/img/icon/add_stash_link_25x25.png"> icon indicates that you can add that collectible to your stash.
	</p>
	<p>
	...
	<p></p>
	<p>
		When you click the <img src="/img/icon/add_stash_link_25x25.png"> icon you will be prompted to fill out some information about the collectible you want to stash.  All of the fields are optional.
	</p>
	...
	<h3 id="submit"> Submitting/Activating a Collectible </h3>
	<p>
