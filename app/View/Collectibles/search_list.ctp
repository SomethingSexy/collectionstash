                        ...
                        echo '<div class="col-md-12 collectible">';
                            echo '<div class="row">';
                                ...
                                echo '<div class="col-md-7">';
                                    ...
                                    echo '<div class="row">';
                                        echo '<div class="col-md-12">';
                                            ...
                                            echo '<a href="/collectibles/view/'.$collectible['Collectible']['id'] .'/' . $collectible['Collectible']['slugField'] .'">' .$name. ' </a>';
                                ...
                                echo '<div class="col-md-3">';
                                    echo '<div class="row">';
                                        echo '<div class="col-md-12 spacer">';
                                        	echo '<div class="pull-right">';
	                                            if ($isLoggedIn && $collectible['Collectible']['status_id'] === '4') {
	                                            	echo '<a title="Add to Stash" class="add-full-to-stash" data-stash-count="' . $stashCount .'" data-wishlist-count="' . $wishlistCount .'" data-collectible=\'' . $collectibleJSON . '\' data-collectible-id="' . $collectible['Collectible']['id'] . '"  href="javascript:void(0)"><img src="/img/icon/add_stash_link_25x25.png"></a>';
	                                            	echo ' <a data-collectible-id="' . $collectible['Collectible']['id'] . '" class="add-to-wishlist" title="Add to Wish List" href="#"><i class="fa fa-star fa-lg"></i></a>';
	                                            }
	                                    	echo '</div>';
                                        echo '</div>';
                                    echo '</div>';
