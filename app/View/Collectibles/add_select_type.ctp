  ...
  <div class="inside">
    ...
    <div class="component-view">
      	<div class="question">
			...
			<dl>
				<dt><?php echo __('Mass-Produced: '); ?></dt>
				<dd><?php echo __('A mass-produced collectible is a collectible that is produced in large amounts for sale (i.e. more than one is made).'); ?></dd>
			</dl>      	
      	</div>
