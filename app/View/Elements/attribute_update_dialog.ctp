<div id="update-attribute-dialog" class="dialog attribute" title="Update Item">
	<div class="component component-dialog">
		<div class="inside" >
			<?php echo $this -> element('flash'); ?>
			<div class="component-info">
				<div>
					<?php echo __('Add a whole bunch of this')
					?>
				</div>
			</div>
			...
			<div class="component-view">
				<div class="attribute-form">
					<?php echo $this -> Form -> create('Attribute', array('data-form-model' => 'Attribute', 'id' => 'AttributeUpdateForm')); ?>
