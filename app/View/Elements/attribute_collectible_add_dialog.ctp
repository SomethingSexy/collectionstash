<div id="attribute-collectible-add-dialog" class="dialog attribute" title="Add New Part">
	<div class="component component-dialog">
		<div class="inside" >
			<?php echo $this -> element('flash'); ?>
			<div class="component-info">
				<div>
					<p><?php echo __('Use this action to add a brand new part to this collectible.');?></p>
				</div>
			</div>
			...
			<div class="component-view">
				<div class="attribute-form">
					<?php echo $this -> Form -> create('Attribute', array('data-form-model' => 'Attribute', 'id' => 'AttributeAddForm', 'type' => 'post')); ?>
					...
					<fieldset class="attribute-collectible-inputs">
						<legend><?php echo __('Collectible Part Details'); ?></legend>
						<ul class="form-fields unstyled">
		                    <li>
								<div class="input number">
									<div class="label-wrapper required">
										<label for="AttributesCollectibleCount">Count</label>
									</div>
									<input id="AttributesCollectibleCount" type="number" name="data[AttributesCollectible][count]">
								</div>
							</li> 
						</ul>								
					</fieldset>
