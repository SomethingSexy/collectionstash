            ...
            <ul class="nav">
              ...
              <?php 
               ...
               {  ?>
                ...
                <li>
                    ...
                    <ul class="subnav">
                        <li><?php echo $html->link('Pending Submissions', array('action' => 'index','controller' => 'adminCollectibles')); ?></li>
                        <li><a href="#">Sub Nav Link</a></li>
                    </ul>
                </li>
                <?php } ?>     
                 <li><?php echo $html->link('Add Collectible', array('action' => 'addSelectType','controller' => 'collectibles')); ?></li>  
              ...
              <?php  }
               ...
               {   ?>
                  ...
                  <li><?php echo $html->link('Register', array('action' => 'register')); ?></li>  
               <?php } ?>
             </ul>
          </div>  
         </div>   
